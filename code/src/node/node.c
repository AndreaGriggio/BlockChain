...
int main(int argc, char *argv[])
{
    ...
    // se arriva sigterm o sigint, handle_signal mette running = 0, in modo che il processo esca in modo sicuro
    struct sigaction sa;
